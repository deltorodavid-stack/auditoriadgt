...
export const AUDIT_BLOCKS: AuditBlock[] = [
  {
    ...
    title: "La Empresa",
    questions: [
      { id: "b1_actividad", label: "¿Cuál es la actividad principal de tu empresa?", type: "textarea" },
      { id: "b1_años", label: "¿Cuántos años lleva operando?", type: "textarea" },
      { id: "b1_legal", label: "¿Cuál es la estructura legal de la empresa?", type: "textarea" },
      { id: "b1_empleados", label: "¿Cuántos empleados tiene actualmente?", type: "textarea" },
      { id: "b1_valores", label: "¿Cuáles son los valores fundamentales (vitales) de la empresa?", type: "textarea" },
      { id: "b1_enfoque", label: "¿Cuál es tu enfoque medular?\n\nInstrucciones: Cuál crees que es tu enfoque vital, a lo que se tiene que dirigir la empresa.", type: "textarea" },
      { id: "b1_mision", label: "¿Cuál es la misión, el propósito de tu empresa?", type: "textarea" },
      { id: "b1_meta_10", label: "¿Cómo ves la empresa a 10 años, tu meta?", type: "textarea" },
      { id: "b1_meta_5", label: "¿Cómo ves la empresa a 5 años, tu meta?", type: "textarea" },
      { id: "b1_estrategia", label: "¿Cuál es tu estrategia de mercado?\n\nInstrucciones: Mercado Objetivo, Las 3 cualidades únicas, Tu proceso comprobado, Tu garantía.", type: "textarea" },
      { id: "b1_cliente_perfil", label: "¿Cuál es tu cliente?\n\nInstrucciones: Identificar a tus clientes ideales.\n- Geográficamente: ¿dónde están?\n- Demográficamente: edad, sexo, puesto de trabajo, ingresos.\n- Psicográficamente: ¿cómo piensan? ¿qué necesitan? ¿qué aprecian?", type: "textarea" },
      { id: "b1_fortalezas", label: "¿Cuáles son tus principales fortalezas como empresa?", type: "textarea" },
      { id: "b1_debilidades", label: "¿Cuáles son las mayores debilidades o retos internos?", type: "textarea" },
      { id: "b1_oportunidades", label: "¿Cuáles son las oportunidades que ves en el mercado?", type: "textarea" },
      { id: "b1_amenazas", label: "¿Cuáles son las amenazas externas que más te preocupan?", type: "textarea" },
      { id: "b1_extra", label: "¿Hay algo más que quieras añadir sobre tu empresa?", type: "free" },
    ],
  },
  {
    number: 2,
