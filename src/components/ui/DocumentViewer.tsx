  ...
  return (
    <div style={{ marginBottom: "20px" }}>
      <div style={{
        ...
        paddingBottom: "4px", borderBottom: "1px solid #e5e7eb", marginBottom: "10px",
      }}>
        {label}
      </div>
      {children}
...
export function DocField({ label, value }: { label: string; value?: string | null }) {
  ...
  return (
    <div style={{ marginBottom: "12px" }}>
      {label && (
        <div style={{ fontSize: "10px", fontWeight: "600", color: "#374151", marginBottom: "3px" }}>
          {label}
        </div>
      )}
      <div style={{ fontSize: "13px", color: "#1f2937", lineHeight: "1.7", whiteSpace: "pre-wrap" }}>
        {value}
      </div>
    </div>
  );
...
export function DocRow({ label, value }: { label: string; value?: string | null }) {
  if (!value) return null;
  return (
    <span style={{ fontSize: "12px", marginRight: "20px", color: "#374151" }}>
