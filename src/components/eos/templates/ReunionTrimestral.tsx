...
const CAMPOS_RESULTADO: { key: keyof Reunion; label: string; hint: string }[] = [
  ...
  { key: "revision_trimestre", label: "Revisión del Trimestre Anterior", hint: "Revisar ingresos, KPIs y estado de las Rocas del trimestre que acaba" },
  ...
  { key: "rocas_proximo", label: "Fijar Rocas del Próximo Trimestre", hint: "1-7 Rocas por persona para el próximo trimestre" },
  { key: "ids", label: "IDS Asuntos Clave", hint: "Identificar, Debatir, Solucionar" },
  { key: "conclusion", label: "Conclusión", hint: "Repasar tareas, comunicar, valorar reunión del 1 al 10" },
];
                ...
                <div className="border-t border-border px-5 py-5 space-y-5">
                  ...
                  <div>
                    ...
                    <div className="mt-3">
                      ...
                      <FieldHint>Puntos y objetivos para el trimestral</FieldHint>
                  ...
                  {!isCompletada ? (
                    ...
                    <div>
                      <p className="mb-3 text-[10px] font-semibold uppercase tracking-widest text-primary">Resultado</p>
